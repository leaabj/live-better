...
export const ErrorResponse = {
  ...
  send(c: Context, message: string, statusCode: number = HTTP_STATUS.INTERNAL_SERVER_ERROR) {
...
export const SuccessResponse = {
  ...
  send(c: Context, data: any, message?: string, statusCode: number = HTTP_STATUS.OK) {
